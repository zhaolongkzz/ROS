...
int main(int argc, char **argv) {
    ...
    // Create service clients to send JointEfforts & get JointProperties
    ...
    // Create publishers: joint torques, velocities, and positions.
    ...
    // Create subscriber: Position Command
